...
def main():
    ...
    xx = np.zeros((num_fips,T+2)) # number of nodes, the columns of attributes
    ...
    E_NewInf_i = simulate_dynamics(data, R0=R0, r=r, num_steps=T, edge_index=edge_index)
    save_dir = '/rds/general/user/qy1815/ephemeral/gnn_version/branching_R0-{}_r-{}/' .format(np.round(R0,2),np.round(r,3))
